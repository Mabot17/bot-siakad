            ...
            <div class="navbar-breadcrumb">
                <h5>
                    @foreach(Request::segments() as $key => $segment)
                        @if($key < 2)
                            <a href="{{ url(implode('/', array_slice(Request::segments(), 0, $key + 1))) }}" style="cursor: pointer;">{{ ucfirst($segment) }}</a>
                            @if($key < 1)
                                <span> > </span>
                            @endif
                        @endif
                    ...
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                        ...
                        <li class="nav-item nav-icon dropdown caption-content">
                            <a href="#" class="search-toggle dropdown-toggle  d-flex align-items-center" id="dropdownMenuButton4"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="{{ asset('images/user/user-2.jpg') }}" class="img-fluid rounded-circle" alt="user">
