...
@if(Session::has('success_update_pembimbing'))
<div class="fixed-bottom p-3">
    <div id="success-update-alert" class="alert text-white bg-success alert-dismissible fade show" role="alert">
        <div class="iq-alert-icon">
           <i class="ri-check-line"></i>
        </div>
        <div class="iq-alert-text">{{ Session::get('success_update_pembimbing') }}</div>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <i class="ri-close-line"></i>
        </button>
    </div>
